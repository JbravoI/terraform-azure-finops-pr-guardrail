...
|---|---|---|---|---|---|---|
| FIN-001 | Show estimated monthly change for a Terraform plan. | Cost-estimation contract | `fixtures/cost-delta/`; cost-comment tests | `action/`, `scripts/` | `docs/architecture/` | Input fixture defined; estimation planned |
| FIN-002 | Identify unsupported or unpriced resources for human review. | Unknown-cost handling | `fixtures/unknown-cost/`; unknown-cost tests | `action/`, `scripts/` | `docs/testing/`, `docs/operations/` | Input fixture defined; enforcement planned |
