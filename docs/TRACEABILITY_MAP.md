...
| REL-001 | Publish a reproducible release with clear limits and operating evidence. | Release checklist | `docs/testing/test-matrix.md` | `CHANGELOG.md`, release tag | `docs/operations/release-process.md`, `docs/releases/` | Local evidence complete; GitHub publication pending |
